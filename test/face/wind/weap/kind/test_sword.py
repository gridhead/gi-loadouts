...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("Serenity's Call", 4, "Level 80/90 (Rank 6)", 427, WeaponStatType.energy_recharge_perc, 55.9, 5, id="face.wind.rule: Configuring weapon - Sword - Serenity's Call"),
        ...
        pytest.param("Peak Patrol Song", 5, "Level 80/90 (Rank 6)", 506, WeaponStatType.defense_perc, 75.4, 5, id="face.wind.rule: Configuring weapon - Sword - Peak Patrol Song"),
        ...
        pytest.param("Sturdy Bone", 4, "Level 80/90 (Rank 6)", 523, WeaponStatType.attack_perc, 25.1, 5, id="face.wind.rule: Configuring weapon - Sword - Sturdy Bone"),
        ...
        pytest.param("Azurelight", 5, "Level 80/90 (Rank 6)", 621, WeaponStatType.critical_rate_perc, 20.1, 5, id="face.wind.rule: Configuring weapon - Sword - Azurelight"),
        ...
        pytest.param("Moonweaver's Dawn", 4, "Level 80/90 (Rank 6)", 523, WeaponStatType.attack_perc, 25.1, 5, id="face.wind.rule: Configuring weapon - Sword - Moonweaver's Dawn"),
