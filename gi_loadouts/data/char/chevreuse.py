...
class Chevreuse(Char):
    ...
    base: BaseStat = BaseStat(
        attack=16.205280303955, defense=50.701351165771, health_points=1002.9700927734
    )
    ascn: BaseStat = BaseStat(
        attack=57.983562469482, defense=181.40849304199, health_points=3588.6091308594
    )
