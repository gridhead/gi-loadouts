...
class SkywardHarp(Bow):
    ...
    seco_stat: WeaponStat = WeaponStat(stat_name=WeaponStatType.critical_rate, stat_data=4.8)
    ...
    refi_stat: List[WeaponStat] = [
        [WeaponStat(stat_name=WeaponStatType.critical_damage, stat_data=20.0)],
        [WeaponStat(stat_name=WeaponStatType.critical_damage, stat_data=25.0)],
        [WeaponStat(stat_name=WeaponStatType.critical_damage, stat_data=30.0)],
        [WeaponStat(stat_name=WeaponStatType.critical_damage, stat_data=35.0)],
        [WeaponStat(stat_name=WeaponStatType.critical_damage, stat_data=40.0)],
    ]
