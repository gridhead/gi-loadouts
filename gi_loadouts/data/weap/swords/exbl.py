...
class ExaiphanesBlade(Sword):
    ...
    refi_list: list[str] = [
        "When the Traveler equips this, their CRIT DMG increases by 0% for every Element they have resonated with. Additionally, the Traveler's ATK will also increase by 16% for 8s, and regenerate 3 Elemental Energy, after they attack and hit an opponent. This effect can trigger once every 5s. This can be triggered even when the character is not on the field.",
