...
class SkywardBlade(Sword):
    ...
    refi_stat: List[WeaponStat] = [
        [WeaponStat(stat_name=WeaponStatType.critical_rate, stat_data=4.0)],
        [WeaponStat(stat_name=WeaponStatType.critical_rate, stat_data=5.0)],
        [WeaponStat(stat_name=WeaponStatType.critical_rate, stat_data=6.0)],
        [WeaponStat(stat_name=WeaponStatType.critical_rate, stat_data=7.0)],
