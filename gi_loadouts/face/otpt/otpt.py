...
class Ui_otptwind:
    def setupUi(self, otptwind):
        ...
        self.head_area.setStyleSheet("#head_area {border: 1px solid rgba(128, 128, 128, 128); border-radius: 5px; background-color: rgba(128, 128, 128, 128);}")
        ...
        self.char_area.setStyleSheet("#char_area {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128); border-radius: 5px;}")
        self.char_area.setFrameShape(QFrame.StyledPanel)
        self.char_area.setFrameShadow(QFrame.Raised)
        ...
        self.char_wish.setStyleSheet("#char_port_area {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.advc_area.setGeometry(QRect(490, 85, 380, 240))
        sizePolicy.setHeightForWidth(self.advc_area.sizePolicy().hasHeightForWidth())
        self.advc_area.setSizePolicy(sizePolicy)
        self.advc_area.setMinimumSize(QSize(380, 240))
        self.advc_area.setMaximumSize(QSize(120, 380))
        self.advc_area.setStyleSheet("#advc_area {border: 1px solid rgba(128, 128, 128, 128); border-radius: 5px;}")
        ...
        self.advc_desc_area.setStyleSheet("#advc_desc_area {border: 1px solid rgba(128, 128, 128, 128); border-top-left-radius: 5px; border-top-right-radius: 5px; background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_crit_base.setStyleSheet("#area_crit_base {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_crit_dmge_head.setStyleSheet("#area_crit_dmge_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_crit_rate_head.setStyleSheet("#area_crit_rate_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_heal_incm_head.setStyleSheet("#area_heal_incm_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_heal_perc_head.setStyleSheet("#area_heal_perc_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_heal_base.setStyleSheet("#area_heal_base {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_enrc.setStyleSheet("#area_enrc {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_cldn.setStyleSheet("#area_cldn {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_sdsh.setStyleSheet("#area_sdsh {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_crit_rate.setStyleSheet("#area_crit_rate {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_crit_dmge.setStyleSheet("#area_crit_dmge {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_heal_perc.setStyleSheet("#area_heal_perc {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_heal_incm.setStyleSheet("#area_heal_incm {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_enrc_head.setStyleSheet("#area_enrc_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_cldn_head.setStyleSheet("#area_cldn_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_sdsh_head.setStyleSheet("#area_sdsh_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.elem_area.setStyleSheet("#elem_area {border: 1px solid rgba(128, 128, 128, 128); border-radius: 5px;}")
        ...
        self.elem_desc_area.setStyleSheet("#elem_desc_area {border: 1px solid rgba(128, 128, 128, 128); border-top-left-radius: 5px; border-top-right-radius: 5px; background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_pyro_base.setStyleSheet("#area_pyro_base {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_pyro_resi.setStyleSheet("#area_pyro_resi {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_pyro_perc.setStyleSheet("#area_pyro_perc {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_pyro_perc_head.setStyleSheet("#area_pyro_perc_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_pyro_resi_head.setStyleSheet("#area_pyro_resi_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_hydo_perc.setStyleSheet("#area_hydo_perc {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_hydo_perc_head.setStyleSheet("#area_hydo_perc_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_hydo_resi_head.setStyleSheet("#area_hydo_resi_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_hydo_base.setStyleSheet("#area_hydo_base {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_hydo_resi.setStyleSheet("#area_hydo_resi {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_dend_resi_head.setStyleSheet("#area_dend_resi_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_dend_resi.setStyleSheet("#area_dend_resi {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_dend_base.setStyleSheet("#area_dend_base {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_dend_perc.setStyleSheet("#area_dend_perc {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_dend_perc_head.setStyleSheet("#area_dend_perc_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_elec_resi_head.setStyleSheet("#area_elec_resi_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_elec_base.setStyleSheet("#area_elec_base {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_elec_perc.setStyleSheet("#area_elec_perc {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_elec_resi.setStyleSheet("#area_elec_resi {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_elec_perc_head.setStyleSheet("#area_elec_perc_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_anem_resi.setStyleSheet("#area_anem_resi {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_anem_base.setStyleSheet("#area_anem_base {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_anem_resi_head.setStyleSheet("#area_anem_resi_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_anem_perc_head.setStyleSheet("#area_anem_perc_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_anem_perc.setStyleSheet("#area_anem_perc {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_cryo_perc_head.setStyleSheet("#area_cryo_perc_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_cryo_resi_head.setStyleSheet("#area_cryo_resi_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_cryo_perc.setStyleSheet("#area_cryo_perc {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_cryo_base.setStyleSheet("#area_cryo_base {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_cryo_resi.setStyleSheet("#area_cryo_resi {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_geox_perc.setStyleSheet("#area_geox_perc {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_geox_resi_head.setStyleSheet("#area_geox_resi_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_geox_base.setStyleSheet("#area_geox_base {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_geox_perc_head.setStyleSheet("#area_geox_perc_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_geox_resi.setStyleSheet("#area_geox_resi {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_phys_perc_head.setStyleSheet("#area_phys_perc_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_phys_resi.setStyleSheet("#area_phys_resi {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_phys_perc.setStyleSheet("#area_phys_perc {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_phys_resi_head.setStyleSheet("#area_phys_resi_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_phys_base.setStyleSheet("#area_phys_base {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.base_area.setStyleSheet("#base_area {border: 1px solid rgba(128, 128, 128, 128); border-radius: 5px;}")
        ...
        self.base_desc_area.setStyleSheet("#base_desc_area {border: 1px solid rgba(128, 128, 128, 128); border-top-left-radius: 5px; border-top-right-radius: 5px; background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_hlpt_head.setStyleSheet("#area_hlpt_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_attk_head.setStyleSheet("#area_attk_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_dfns_head.setStyleSheet("#area_dfns_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_elma_head.setStyleSheet("#area_elma_head {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_hlpt.setStyleSheet("#area_hlpt {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_attk.setStyleSheet("#area_attk {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_dfns.setStyleSheet("#area_dfns {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
        ...
        self.area_elma.setStyleSheet("#area_elma {border: 1px solid rgba(128, 128, 128, 128); background-color: rgba(128, 128, 128, 128);}")
