...
class AdvancedStats(BaseModel):
    ...
    incoming_healing_bonus_perc: ATTR = ATTR(
        stat_name=STAT.incoming_healing_bonus_perc, stat_data=0.0
    )
...
class ElementalStats(BaseModel):
    ...
    damage_bonus_physical_perc: ATTR = ATTR(
        stat_name=STAT.damage_bonus_physical_perc, stat_data=0.0
    )
